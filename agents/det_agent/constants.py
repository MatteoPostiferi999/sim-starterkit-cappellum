...
# ── Day-of-week priors (empirical from v1 12-game eval) ────────────────────────
# Survival-recon priors were 2-3x too low — v1 reveals real demand levels.
DOW_COVERS_PRIOR: dict[str, float] = {
    "Monday": 120.0, "Tuesday": 155.0, "Wednesday": 170.0, "Thursday": 185.0,
    "Friday": 245.0, "Saturday": 235.0, "Sunday": 160.0,
}
...
# Approx kitchen throughput (covers per staff per day) — recalibrated from v1
# (recon was at low demand; real ceiling is closer to 18-20 covers/staff/day)
KITCHEN_THROUGHPUT_PER_STAFF = 18.0
TABLE_CAPACITY_NORMAL = 220   # observed peak served — table+turn limit, not 115
TABLE_CAPACITY_RENOVATION = 110

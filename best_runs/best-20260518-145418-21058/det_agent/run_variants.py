...
VARIANTS: dict[str, dict[str, str]] = {
    # Code-only changes — default config
    "baseline":      {},
    # Pricing hotter
    "price_hot":     {"DET_BASE_PRICE_SHIFT": "0.08", "DET_PREMIUM_EXTRA": "0.06"},
    "price_very_hot": {"DET_BASE_PRICE_SHIFT": "0.10", "DET_PREMIUM_EXTRA": "0.07",
                      "DET_WEEKEND_LIFT": "0.06", "DET_END_GAME_LIFT": "0.08"},
    # Lean staff
    "lean_staff":    {"DET_STAFF_DELTA": "-1"},
    # Marketing strategies
    "mkt_heavy":     {"DET_MARKETING_MODE": "heavy"},
    "mkt_off":       {"DET_MARKETING_MODE": "off"},
    # Happy hour aggressive
    "hh_aggressive": {"DET_HH_MODE": "aggressive"},
    # Combined: hot price + lean staff
    "hot_lean":      {"DET_BASE_PRICE_SHIFT": "0.08", "DET_PREMIUM_EXTRA": "0.06",
                      "DET_STAFF_DELTA": "-1"},
    # Tighter orders
    "tight_orders":  {"DET_OVER_ORDER": "1.15", "DET_BUFFER_FRESH": "2",
                      "DET_BUFFER_DRY": "4"},
}
